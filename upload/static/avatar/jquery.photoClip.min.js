...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
  ...
  var defaultOptions = {
    ...
    errorMsg: {
      noSupport: 'เบราว์เซอร์ของคุณเก่าเกินไป ไม่สนับสนุนการใช้งานฟังก์ชั่นตัดรูป กรุณาเปลี่ยนเบราว์เซอร์ใหม่!',
      imgError: 'รูปแบบไฟล์รูปภาพไม่สนับสนุน กรุณาเลือกไฟล์รูปภาพที่เป็นรูปแบบทั่วไป!',
      imgHandleError: 'ขออภัย! เกิดข้อผิดพลาดในการประมวลผลรูปภาพ กรุณาลองใช้รูปภาพอื่น',
      imgLoadError: 'โหลดรูปภาพไม่สำเร็จ รูปภาพอาจมีขนาดใหญ่เกินไป กรุณาลองเปลี่ยนรูปภาพอื่น',
      imgSizeError: 'รูปภาพมีขนาดใหญ่เกินไป กรุณาเลือกใหม่',
      noImg: 'ไม่มีรูปภาพที่สามารถครอปได้',
      clipError: 'แคปเจอร์หน้าจอไม่สำเร็จ ไฟล์รูปภาพต้นทางอาจมีปัญหาเกี่ยวกับโดเมนข้ามเว็บ กรุณาตรวจสอบให้แน่ใจว่ารูปภาพและแอปพลิเคชันอยู่บนโดเมนเดียวกัน หากคุณกำลังรันโปรแกรมนี้บนสภาพแวดล้อมแบบโลคัล กรุณาเปลี่ยนไปใช้สภาพแวดล้อมเซิร์ฟเวอร์'
    }
  };
